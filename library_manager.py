...
#       #load library
# load_library() # 
# st.sidebar.markdown("<h1 style='text-aligin: center;'> Navigation</h1>",unsafe_allow_html=True)
...
# st.markdown("<h1 class='main=header'> Personal Library Manage </h1>", unsafe_allow_html=True)
...
#     submit_button = st.form_submit_button(label="Add_book")
...
#                         <p><span class= 'if{"read-badge" if book["read_status"] else "unread-badge"}'>{
...
#                         with col1:
#                             if st.button(f"Remove", key=f"remove_{1}", use_container_width=True):
#                                 if remove_book(i):
#                                     st.rerun()
#                                     with col2:
...
#                 st.markdown("<h2 class='sub-header'> Lbrary statistics</h2>",unsafe_allow_html=True )

#                 if not st.session_state.library:
#                     st.markdown("<div class='warning-message'> Your Library is emptty. Add some books to see stats!</div>",unsafe_allow_html=True)
#                 else:
...
#                          with col3:
#                              st.metric("percentage Read", f"{stats['percantage_read'] :.1f}%")
#                              create_visulations()
...
#         'Category': ['Books Read', 'Total Books', 'Read %'],
#         'Count': [stats['read_books'], stats['total_books'], stats['percent_read']]
#     })
